...
Console.WriteLine("|------------------------------------------------------------------------|");
Console.WriteLine("|                                                                        |");
Console.WriteLine("|          Autor: Julián Marcelo Zappia. CORREGIDO 27/05/2022            |");
Console.WriteLine("|                                                                        |");
Console.WriteLine("|------------------------------------------------------------------------|");
...
// Inicio de variables y vectores (principales y auxiliares). Método Random.
...
// Inicializo vector con ceros (por repetición de valores).
...
// Cargo vector con números aleatorios.
...
// Inicio nueva inversión de vector con variables auxiliares.
// Asignado como corrección por el Profesor Eugenio el 26/05/2022.
...
for (int k = 0; k < VectorNormal.Length; k++)
{
    ...
    CadenaMensaje = "Valor en vector INVERTIDO, posición " + k.ToString() + ": " + VectorNormal[k].ToString();
    Console.WriteLine(CadenaMensaje);
}
